...
export const copy = {
  ...
  login: {
    ...
    forgotSubtitle: "登録メールアドレスに確認コードを送信します",
    forgotSubmit: "確認コードを送信",
    forgotCode: "確認コード",
  ...
  survey: {
    ...
    rootFolderPlaceholder: "選択または入力",
    rootFolderRequired: "ルートフォルダを選択してください",
    rootFolderLast: "前回",
    rootFolderEmpty: "Drive上にルートフォルダがありません",
    rootFolderLoading: "フォルダを確認中…",
    rootFolderGone: "このフォルダはDrive上にありません。別のフォルダを選ぶか、新しい名前を入力してください",
    rootFolderWillCreate: "登録時に新しいルートフォルダを作成します",
    rootFolderSelectExisting: "候補から既存フォルダを選ぶか、新規名を入力してください",
  ...
  table: {
    ...
    searchPlaceholder: "フロア・場所・シンボル・種別・品番などで検索…",
    pageSize: "表示件数",
  ...
  auth: {
    ...
    changePasswordSubmit: "パスワードを変更",
    changePasswordSuccess: "パスワードを変更しました",
    changePasswordHint: "8文字以上で設定してください",
  },
  users: {
    title: "ユーザー管理",
    subtitle: "アカウントの一覧・追加・削除",
    addUser: "ユーザーを追加",
    email: "メールアドレス",
    displayName: "表示名（任意）",
    tempPassword: "仮パスワード",
    tempPasswordHint: "初回ログイン時に変更が必要です",
    ...
    deleteBody: (email: string) => `${email} を削除します。この操作は元に戻せません。`,
    deleteConfirm: "削除する",
    deleteCancel: "キャンセル",
    superAdminOnly: "削除はスーパー管理者のみ可能です",
    adminNotConfigured:
      "ユーザー管理には Cognito Identity Pool の設定が必要です。管理者に COGNITO.md をご確認ください。",
    previewNote: "プレビュー環境のデモ表示です",
  },
  errors: {
    ...
    ocrPayloadTooLarge:
      "ファイルが大きすぎて読み取りサーバーに送れません。画質を下げるか、ファイルを分けて再度お試しください。",
    ocrPdfProtected:
      "このPDFはパスワード保護されています。保護を解除してからアップロードしてください。",
    ocrPdfFailed: "PDFの変換に失敗しました。別のファイルでお試しください。",
  },
} as const;
